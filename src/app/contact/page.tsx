      ...
      <div className="py-12">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 border-t border-border mt-12 grid grid-cols-1 md:grid-cols-2 gap-24">
          <div>
            ...
            <p className="text-muted font-code text-sm">info@foursix46.com</p>
            <p className="text-muted font-code text-sm">+44 (0) 20 7946 0123</p>
          </div>
          <div>
            <h2 className="text-2xl font-black uppercase mb-6">HQ Address</h2>
            <p className="text-muted font-code text-sm">
