...
export default function VenturesPage() {
  return (
    <main className="min-h-screen bg-black">
      <Navbar />
      <div className="pt-24">
        <header className="px-6 py-24 max-w-7xl mx-auto border-b border-white/5">
          <span className="font-sans text-[10px] font-semibold uppercase tracking-[0.5em] text-primary mb-6 block">
            The Collective
          </span>
          <h1 className="text-6xl md:text-8xl font-sans font-black uppercase tracking-tighter leading-none mb-8">
            OUR<br />
            <span className="text-white/40">VENTURES</span>
          </h1>
          <p className="text-xl text-white/50 max-w-2xl font-light leading-relaxed tracking-tight">
        ...
        <div className="max-w-7xl mx-auto px-6 py-32 border-t border-white/5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-start">
            <div>
              <h2 className="text-4xl font-sans font-black uppercase mb-8 tracking-tighter">Strategic Investment</h2>
