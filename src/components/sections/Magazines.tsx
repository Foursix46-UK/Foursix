    ...
    <section id="magazines" ref={ref} className="py-32 px-6 overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <div className="text-center mb-24">
          ...
          <h3 className="text-7xl md:text-9xl font-headline font-black uppercase tracking-tighter">
            THE JOURNAL
          </h3>
        </div>
              ...
              >
                <div className="aspect-[3/4] relative overflow-hidden rounded-sm border border-border">
                  ...
                  <div className="absolute top-8 left-8">
                    <span className="px-4 py-2 bg-primary text-white text-xs font-black uppercase tracking-widest">
                      {mag.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-8 space-y-2">
                  <h4 className="text-4xl font-headline font-black uppercase group-hover:text-primary transition-colors">
                    {mag.title}
                  </h4>
                  <p className="text-muted font-code text-sm">Quarterly Issue · Available in Print & Digital</p>
                </div>
              </motion.div>
            );
          })}
