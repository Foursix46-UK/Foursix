      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <div className="text-left space-y-8 order-2 lg:order-1">
            ...
            <TypewriterText text={data?.heroTypewriter || "Architecting the global nodes of tomorrow. A collective of disruptive ventures unified by strategic leadership and generational impact."} />
          </div>
